...
document.getElementById("presButton").addEventListener("click", function presButton() {
    ...
    setTimeout(()=>{
        infoBox(`Celtic Mythology Presentation`, `<div class="bodyVideoWrapper">
        ...
        </div>`, `https://issuu.com/gzr529/docs/guseyn_zarbaliyev_-_fairy_tale_creative_writing_pi`, true, currentValue, `https://res.cloudinary.com/dtjiibzcn/image/upload/v1670860334/1x1_vvdr6w.png`, "full");
        infoBox(`David and Goliath Bible Presentation`, `<div class="bodyVideoWrapper">
