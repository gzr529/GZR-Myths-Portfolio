...
document.getElementById("essayButton").addEventListener("click", function essayButton1() {
    bodySection.style.opacity = "0";
...
document.getElementById("presButton").addEventListener("click", function presButton1() {
    bodySection.style.opacity = "0";
    ...
    setTimeout(()=>{
        presBox(`Celtic Mythology Presentation`, `<div class="bodyVideoWrapper">
        ...
        </div>`, `https://docs.google.com/presentation/d/1xJjiyg86yTakVPs4nT0KH0Z_YJqIaHfI12vMZ1gQlCE/edit?usp=sharing`, true, currentValue, `https://res.cloudinary.com/dtjiibzcn/image/upload/v1670860334/1x1_vvdr6w.png`, "full");
        presBox(`David and Goliath Bible Presentation`, `<div class="bodyVideoWrapper">
        ...
        </div>`, `https://docs.google.com/presentation/d/1LYHYTYhdTwBgWxtaX1eBp6EPOr7GDYEUPlriF8b1J-c/edit?usp=sharing`, true, currentValue, `https://res.cloudinary.com/dtjiibzcn/image/upload/v1670860334/1x1_vvdr6w.png`, "full");
        presBox(`Norse (Gerd and Frey) Presentation`, `<div class="bodyVideoWrapper">
        <iframe class="bodyVideo" src="https://www.youtube.com/embed/u_OlXW4wIGg"></iframe>
        </div>`, `https://www.youtube.com/watch?v=u_OlXW4wIGg`, true, currentValue, `https://res.cloudinary.com/dtjiibzcn/image/upload/v1670860334/1x1_vvdr6w.png`, "full");
        imgOne.remove();
    }, 1000);
    setTimeout(()=>{
        bodySection.style.opacity = "1";
...
document.getElementById("reflButton").addEventListener("click", function reflButton1() {
    bodySection.style.opacity = "0";
