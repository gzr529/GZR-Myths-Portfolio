...
document.getElementById("presButton").addEventListener("click", function presButton() {
    ...
    setTimeout(()=>{
        ...
        </div>`, `https://docs.google.com/presentation/d/17IN3PgDjWq04AIruyPtNQ4yLo73TxmvNZnEjd4lVhh4/edit?usp=sharing`, true, currentValue, `https://res.cloudinary.com/dtjiibzcn/image/upload/v1670860334/1x1_vvdr6w.png`, "full");
